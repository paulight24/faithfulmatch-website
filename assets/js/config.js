// Central place to enable store links once the app is published.
// Until real URLs are supplied, both stay null and the site renders
// disabled "Coming soon" badges instead of linking anywhere.
window.FM_CONFIG = {
